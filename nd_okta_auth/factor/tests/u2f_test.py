...
CHALLENGE_RESPONSE = {
    ...
    "_embedded": {
        "factor": {
            ...
            "_embedded": {"challenge": {"nonce": "anonce", "timeoutSeconds": 20}},
            "id": "123",
            "factorType": "u2f",
            "provider": "FIDO",
            "vendorName": "FIDO",
...
class OktaTest(unittest.TestCase):
    ...
    def test_u2f_success(self):
        ...
        mock_client.sign.return_value = {"clientData": "foo", "signatureData": "bar"}
        ...
        u2f_factor._get_client.assert_called_once_with(
            mock_device, "https://foobar" ".okta.com"
        )
        registered_keys = [{"version": "U2F_V2", "keyHandle": "asfodiuhdwacdas"}]
        mock_client.sign.assert_called_once_with(
            "https://foobar.okta.com", "anonce", registered_keys
        )

        calls = [
            mock.call(
                "/authn/factors/123/verify", {"fid": "123", "stateToken": "XXXTOKENXXX"}
            ),
            mock.call(
    ...
    def test_u2f_wait(self):
        ...
        mock_device = mock.MagicMock(name="mock_device")
        u2f_factor._get_devices = mock.MagicMock(name="_get_devices")
        u2f_factor._get_devices.return_value = [
            None,
            None,
            None,
            None,
    ...
    def test_u2f_client_error(self):
        ...
        # Mock call to Okta API
        u2f_factor._request = mock.MagicMock(name="_request")
        u2f_factor._request.side_effect = [CHALLENGE_RESPONSE]
