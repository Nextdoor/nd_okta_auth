...
CHALLENGE_RESPONSE = {
    ...
    "_embedded": {
        "factor": {
            ...
            "_embedded": {"challenge": {"challenge": NONCE_ENC, "extensions": {}}},
            "id": "123",
            "factorType": "webauthn",
            "provider": "FIDO",
            "vendorName": "FIDO",
...
class OktaTest(unittest.TestCase):
    ...
    def test_webauthn_success(self):
        ...
        options = PublicKeyCredentialRequestOptions(
            challenge=NONCE_STR, rp_id="foobar.okta.com", allow_credentials=allow_list
        )
    ...
    def test_webauthn_wait(self):
        ...
        mock_device = mock.MagicMock(name="mock_device")
        webauthn._get_devices = mock.MagicMock(name="_get_devices")
        webauthn._get_devices.return_value = [
            None,
            None,
            None,
            None,
    ...
    def test_webauthn_client_error(self):
        ...
        # Mock call to Okta API
        webauthn._request = mock.MagicMock(name="_request")
        webauthn._request.side_effect = [CHALLENGE_RESPONSE]
